      ...
      <div className="bg-gray-800 p-8 rounded-xl shadow-lg border border-gray-700 space-y-6">
        ...
        <div className="flex items-center justify-between py-2">
          ...
          <label className="relative inline-flex items-center cursor-pointer">
            ...
            />
            <div
              className={`w-11 h-6 bg-gray-600 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-orange-600 ${settings.autostartHidden ? 'opacity-50 cursor-not-allowed' : ''}`}
            ></div>
          </label>
        </div>
        ...
        <div className="flex items-center justify-between py-2">
          <div>
            ...
            <p className="text-gray-400 text-sm">
              If disabled, lights configured to autostart will turn on every time you open the app manually too.
            </p>
          </div>
          <label className="relative inline-flex items-center cursor-pointer">
            <input
