             ...
             <div className="bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-700">
                ...
                {discoveredLights.length === 0 ? (
                    <div className="text-gray-500 text-center py-8">
                        No lights found automatically yet.
                    </div>
                ) : (
                    <ul className="space-y-3">
                        {discoveredLights.map((light, idx) => (
                            <li key={idx} className="flex justify-between items-center bg-gray-700/50 p-4 rounded-lg border border-gray-600 hover:border-gray-500 transition-colors">
                                <div>
